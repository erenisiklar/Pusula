...
/** Wikipedia article title for each university prefix — used as fallback image source */
export const WIKI_TITLES: Record<string, string> = {
  "tu-delft":       "Delft_University_of_Technology",
  "amsterdam":      "University_of_Amsterdam",
  "groningen":      "University_of_Groningen",
  "maastricht":     "Maastricht_University",
  "erasmus":        "Erasmus_University_Rotterdam",
  "utrecht":        "Utrecht_University",
  "leiden":         "Leiden_University",
  "eindhoven":      "Eindhoven_University_of_Technology",
  "tilburg":        "Tilburg_University",
  "twente":         "University_of_Twente",
  "wageningen":     "Wageningen_University_%26_Research",
  "radboud":        "Radboud_University",
  "vu":             "Vrije_Universiteit_Amsterdam",
  "bocconi":        "Bocconi_University",
  "polimi":         "Polytechnic_University_of_Milan",
  "bologna":        "University_of_Bologna",
  "padua":          "University_of_Padua",
  "trento":         "University_of_Trento",
  "luiss":          "LUISS",
  "milan":          "University_of_Milan",
  "cafoscari":      "Ca%27_Foscari_University_of_Venice",
  "torino":         "University_of_Turin",
  "sapienza":       "Sapienza_University_of_Rome",
  "pavia":          "University_of_Pavia",
  "polito":         "Polytechnic_University_of_Turin",
  "tum":            "Technical_University_of_Munich",
  "rwth":           "RWTH_Aachen_University",
  "jacobs":         "Constructor_University",
  "constructor":    "Constructor_University",
  "tu-berlin":      "Technical_University_of_Berlin",
  "lmu":            "Ludwig_Maximilian_University_of_Munich",
  "mannheim":       "University_of_Mannheim",
  "ebs":            "EBS_Universit%C3%A4t_f%C3%BCr_Wirtschaft_und_Recht",
  "whu":            "WHU_%E2%80%93_Otto_Beisheim_School_of_Management",
  "kit":            "Karlsruhe_Institute_of_Technology",
  "bard":           "Bard_College_Berlin",
  "escp":           "ESCP_Business_School",
  ...
  "kcl":            "King%27s_College_London",
  "edinburgh":      "University_of_Edinburgh",
  "manchester":     "University_of_Manchester",
  "warwick":        "University_of_Warwick",
  "bristol":        "University_of_Bristol",
  "bath":           "University_of_Bath",
  "glasgow":        "University_of_Glasgow",
  "exeter":         "University_of_Exeter",
  "leeds":          "University_of_Leeds",
  "birmingham":     "University_of_Birmingham",
  "nottingham":     "University_of_Nottingham",
  "sheffield":      "University_of_Sheffield",
  "southampton":    "University_of_Southampton",
  "durham":         "Durham_University",
  "lancaster":      "Lancaster_University",
  "standrews":      "University_of_St_Andrews",
  "loughborough":   "Loughborough_University",
  "queen-mary":     "Queen_Mary_University_of_London",
  "york":           "University_of_York",
  "liverpool":      "University_of_Liverpool",
  "sussex":         "University_of_Sussex",
  "newcastle":      "Newcastle_University",
  "qub":            "Queen%27s_University_Belfast",
  "sciences-po":    "Sciences_Po",
  "essec":          "ESSEC_Business_School",
  "edhec":          "EDHEC_Business_School",
  "emlyon":         "EM_Lyon",
  "audencia":       "Audencia",
  "neoma":          "NEOMA_Business_School",
  "kedge":          "KEDGE_Business_School",
  "ieseg":          "I%C3%89SEG_School_of_Management",
  "skema":          "SKEMA_Business_School",
  "ie":             "IE_University",
  "esade":          "ESADE",
  "carlos-iii":     "Charles_III_University_of_Madrid",
  "pompeu-fabra":   "Pompeu_Fabra_University",
  "autonoma-madrid":"Autonomous_University_of_Madrid",
  "navarra":        "University_of_Navarra",
  "ub":             "University_of_Barcelona",
  "lund":           "Lund_University",
  "kth":            "KTH_Royal_Institute_of_Technology",
  "stockholm":      "Stockholm_University",
  "sse":            "Stockholm_School_of_Economics",
  "gothenburg":     "University_of_Gothenburg",
  "karolinska":     "Karolinska_Institute",
  "uppsala":        "Uppsala_University",
  "linkoping":      "Link%C3%B6ping_University",
  "cbs":            "Copenhagen_Business_School",
  "aarhus":         "Aarhus_University",
  "copenhagen":     "University_of_Copenhagen",
  "dtu":            "Technical_University_of_Denmark",
  "sdu":            "University_of_Southern_Denmark",
  "aalborg":        "Aalborg_University",
  "nhh":            "NHH_Norwegian_School_of_Economics",
  "bi-norwegian":   "BI_Norwegian_Business_School",
  "aalto":          "Aalto_University",
  "helsinki":       "University_of_Helsinki",
  "tampere":        "Tampere_University",
  "turku":          "University_of_Turku",
  "kuleuven":       "KU_Leuven",
  "ghent":          "Ghent_University",
  "antwerp":        "University_of_Antwerp",
  "nova":           "Nova_School_of_Business_and_Economics",
  "catolica":       "Universidade_Cat%C3%B3lica_Portuguesa",
  "iscte":          "ISCTE_%E2%80%93_University_Institute_of_Lisbon",
  "trinity":        "Trinity_College_Dublin",
  "ucd":            "University_College_Dublin",
  "ucc":            "University_College_Cork",
  "st-gallen":      "University_of_St._Gallen",
  "modul":          "Modul_University_Vienna",
  "wu":             "Vienna_University_of_Economics_and_Business",
  "kozminski":      "Kozminski_University",
  "sgh":            "SGH_Warsaw_School_of_Economics",
  "warsaw":         "University_of_Warsaw",
  "charles":        "Charles_University",
  "masaryk":        "Masaryk_University",
  "corvinus":       "Corvinus_University_of_Budapest",
  "taltech":        "TalTech",
  "tartu":          "University_of_Tartu",
};

/** Get Wikipedia article title for a university by its map data ID */
export function getWikiTitle(id: string): string | null {
  const prefixes = Object.keys(WIKI_TITLES).sort((a, b) => b.length - a.length);
  const prefix = prefixes.find((p) => id === p || id.startsWith(p + "-"));
  return prefix ? WIKI_TITLES[prefix] : null;
}
